Shader "Unreal/MI_Rock01"
{
	Properties
	{
		...
		Material_Texture2D_2( "Metal", 2D ) = "white" {}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local4 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 3);
	...
	MaterialFloat Local6 = MaterialStoreTexSample(Parameters, Local5, 3);
	MaterialFloat Local7 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 4);
	...
	MaterialFloat Local10 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 0);
	MaterialFloat4 Local11 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat Local12 = MaterialStoreTexSample(Parameters, Local11, 0);
	MaterialFloat Local13 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 2);
	MaterialFloat4 Local14 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4, Material_Texture2D_4Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	...
	PixelMaterialInputs.Metallic = Local8.rgb;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local11.rgb;
