Shader "Unreal/MI_Sky_Stars_01_Inst"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.125000,0.125000,0.125000,0.000000);//All Multiply
	Material.VectorExpressions[3] = float4(0.125000,0.125000,0.125000,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[0] = float4(0.000000,1.000000,0.000000,0.000000);//Desaturate Texture All Power (Unknown) (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local5 = (Local4 * Material.VectorExpressions[3].rgb);
	MaterialFloat3 Local6 = (Material.VectorExpressions[4].rgb + Local5);
	MaterialFloat3 Local7 = PositiveClampedPow(Local6,Material.ScalarExpressions[0].y);
	MaterialFloat3 Local8 = lerp(Local7,Material.VectorExpressions[5].rgb,MaterialFloat(Material.ScalarExpressions[0].z));
