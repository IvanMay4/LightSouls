Shader "Unreal/MI_Clouds_562_Col_C_01_Inst"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(0.479167,0.479167,0.479167,1.000000);//Midtones Color - Multiply
	Material.VectorExpressions[2] = float4(0.046875,0.046875,0.046875,1.000000);//Shadows Color - Multiply
	Material.VectorExpressions[3] = float4(0.046875,0.046875,0.046875,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(0.479167,0.479167,0.479167,0.000000);//(Unknown)
	Material.VectorExpressions[5] = float4(0.606228,0.731082,0.786458,1.000000);//Highlights Color - Multiply
	Material.VectorExpressions[6] = float4(0.606228,0.731082,0.786458,0.000000);//(Unknown)
	Material.VectorExpressions[7] = float4(1.000000,1.000000,1.000000,1.000000);//Up Color
	Material.VectorExpressions[8] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[9] = float4(0.000000,0.000000,0.000000,1.000000);//Down Color
	Material.VectorExpressions[10] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[11] = float4(0.032091,0.035315,0.036458,1.000000);//All Multiply
	Material.VectorExpressions[12] = float4(0.032091,0.035315,0.036458,0.000000);//(Unknown)
	Material.VectorExpressions[13] = float4(0.000000,0.000000,0.000000,1.000000);//All Additive
	Material.VectorExpressions[14] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[15] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.600000,0.000000,0.000000,0.900000);//Desaturate Texture Up Color - Lerp Down Color - Lerp All Power
	Material.ScalarExpressions[1] = float4(0.000000,1.000000,0.000000,0.000000);//(Unknown) All Opacity RefractionDepthBias (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local3 = dot(Local1.rgb, MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local4 = lerp(Local1.rgb,MaterialFloat3(Local3,Local3,Local3),MaterialFloat(Material.ScalarExpressions[0].x));
	...
	MaterialFloat3 Local8 = lerp(Material.VectorExpressions[4].rgb,Material.VectorExpressions[3].rgb,MaterialFloat(Local6.g));
	MaterialFloat3 Local9 = lerp(Local8,Material.VectorExpressions[6].rgb,MaterialFloat(Local6.r));
	MaterialFloat Local10 = (1.00000000 - Local6.b);
	MaterialFloat Local11 = lerp(0.00000000,Local10,Material.ScalarExpressions[0].y);
	MaterialFloat3 Local12 = lerp(Local9,Material.VectorExpressions[8].rgb,MaterialFloat(Local11));
	MaterialFloat Local13 = lerp(0.00000000,Local6.b,Material.ScalarExpressions[0].z);
	MaterialFloat3 Local14 = lerp(Local9,Material.VectorExpressions[10].rgb,MaterialFloat(Local13));
	MaterialFloat3 Local15 = lerp(Local12,Local14,MaterialFloat(0.50000000));
	MaterialFloat3 Local16 = (Local4 * Local15);
	MaterialFloat3 Local17 = (Local16 * Material.VectorExpressions[12].rgb);
	MaterialFloat3 Local18 = (Local17 + Material.VectorExpressions[14].rgb);
	MaterialFloat3 Local19 = PositiveClampedPow(Local18,Material.ScalarExpressions[0].w);
	MaterialFloat3 Local20 = lerp(Local19,Material.VectorExpressions[15].rgb,MaterialFloat(Material.ScalarExpressions[1].x));
	MaterialFloat Local21 = (Material.ScalarExpressions[1].y * Local1.a);
	...
	PixelMaterialInputs.Refraction = MaterialFloat2(MaterialFloat2(MaterialFloat2(1.00000000,0.00000000).r,0).r,Material.ScalarExpressions[1].z);
