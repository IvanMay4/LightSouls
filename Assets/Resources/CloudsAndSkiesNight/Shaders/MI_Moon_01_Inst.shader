...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(0.489583,0.445777,0.413086,1.000000);//Shadows Color
	Material.VectorExpressions[2] = float4(1.000000,0.971142,0.927083,1.000000);//Highlights Color
	Material.VectorExpressions[3] = float4(1.000000,0.971142,0.927083,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(0.489583,0.445777,0.413086,0.000000);//(Unknown)
	Material.VectorExpressions[5] = float4(1.000000,1.000000,1.000000,1.000000);//All Multiply
	Material.VectorExpressions[6] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[7] = float4(0.676541,0.817248,0.895833,1.000000);//All Additive
	Material.VectorExpressions[8] = float4(0.676541,0.817248,0.895833,0.000000);//(Unknown)
	Material.VectorExpressions[9] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(3.000000,0.000000,0.200000,1.000000);//All Power (Unknown) Opacity Mask Switch All Opacity
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,0.000000,0.000000);//RefractionDepthBias (Unknown) (Unknown) (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local6 = lerp(Material.VectorExpressions[4].rgb,Material.VectorExpressions[3].rgb,MaterialFloat(Local4.r));
	MaterialFloat3 Local7 = (Local1.rgb * Local6);
	MaterialFloat3 Local8 = (Local7 * Material.VectorExpressions[6].rgb);
	MaterialFloat3 Local9 = (Local8 + Material.VectorExpressions[8].rgb);
	MaterialFloat3 Local10 = PositiveClampedPow(Local9,Material.ScalarExpressions[0].x);
	MaterialFloat3 Local11 = lerp(Local10,Material.VectorExpressions[9].rgb,MaterialFloat(Material.ScalarExpressions[0].y));
	MaterialFloat Local12 = lerp(Local4.g,Local4.b,Material.ScalarExpressions[0].z);
	MaterialFloat Local13 = (Material.ScalarExpressions[0].w * Local12);
