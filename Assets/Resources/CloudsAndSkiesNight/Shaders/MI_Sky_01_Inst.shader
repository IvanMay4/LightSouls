...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(0.000000,0.000000,0.000000,0.000000);//All Additive
	Material.VectorExpressions[2] = float4(1.000000,1.000000,1.000000,0.000000);//All Multiply
	...
	Material.VectorExpressions[5] = float4(1.000000,1.000000,1.000000,1.000000);//Up Color
	Material.VectorExpressions[6] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[7] = float4(1.000000,1.000000,1.000000,1.000000);//Down Color
	...
	Material.ScalarExpressions[0] = float4(2.000000,0.700000,0.000000,0.000000);//Source Power Source Brightness Desaturate Texture Up Color - Lerp
	Material.ScalarExpressions[1] = float4(0.000000,1.000000,0.000000,0.000000);//Down Color - Lerp All Power (Unknown) (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local3 = PositiveClampedPow(Local1.rgb,Material.ScalarExpressions[0].x);
	MaterialFloat3 Local4 = (Local3 * Material.ScalarExpressions[0].y);
	MaterialFloat Local5 = dot(Local4, MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local6 = lerp(Local4,MaterialFloat3(Local5,Local5,Local5),MaterialFloat(Material.ScalarExpressions[0].z));
	MaterialFloat3 Local7 = (Local6 * Material.VectorExpressions[3].rgb);
	MaterialFloat3 Local8 = (Material.VectorExpressions[4].rgb + Local7);
	MaterialFloat2 Local9 = (Parameters.TexCoords[0].xy * MaterialFloat2(0.00000000,2.00000000));
	MaterialFloat Local10 = (1.00000000 - Local9.g);
	MaterialFloat Local11 = lerp(0.00000000,Local10,Material.ScalarExpressions[0].w);
	MaterialFloat3 Local12 = lerp(Local8,Material.VectorExpressions[6].rgb,MaterialFloat(Local11));
	MaterialFloat Local13 = lerp(0.00000000,Local9.g,Material.ScalarExpressions[1].x);
	MaterialFloat3 Local14 = lerp(Local8,Material.VectorExpressions[8].rgb,MaterialFloat(Local13));
	MaterialFloat3 Local15 = lerp(Local12,Local14,MaterialFloat(0.50000000));
	MaterialFloat3 Local16 = PositiveClampedPow(Local15,Material.ScalarExpressions[1].y);
	MaterialFloat3 Local17 = lerp(Local16,Material.VectorExpressions[9].rgb,MaterialFloat(Material.ScalarExpressions[1].z));
