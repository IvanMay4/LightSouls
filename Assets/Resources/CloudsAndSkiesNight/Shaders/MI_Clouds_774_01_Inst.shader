Shader "Unreal/MI_Clouds_774_01_Inst"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(1.000000,1.000000,1.000000,1.000000);//Midtones Color
	Material.VectorExpressions[2] = float4(1.000000,1.000000,1.000000,1.000000);//Shadows Color
	...
	Material.VectorExpressions[5] = float4(1.000000,1.000000,1.000000,1.000000);//Highlights Color
	...
	Material.VectorExpressions[9] = float4(1.000000,1.000000,1.000000,1.000000);//Down Color
	Material.VectorExpressions[10] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[11] = float4(1.000000,1.000000,1.000000,1.000000);//All Multiply
	Material.VectorExpressions[12] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[0] = float4(0.000000,0.000000,0.000000,1.000000);//Desaturate Texture Up Color - Lerp Down Color - Lerp All Power
