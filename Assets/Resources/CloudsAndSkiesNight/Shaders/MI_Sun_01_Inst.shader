Shader "Unreal/MI_Sun_01_Inst"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "Mask", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(1.000000,1.000000,1.000000,0.000000);//Sun Color
	Material.VectorExpressions[2] = float4(1.000000,0.595416,0.089927,1.000000);//Halo Color
	Material.VectorExpressions[3] = float4(1.000000,0.595416,0.089927,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[5] = float4(1.000000,1.000000,1.000000,1.000000);//Multiply
	Material.VectorExpressions[6] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[7] = float4(1.000000,1.000000,1.000000,1.000000);//Additive
	...
	Material.ScalarExpressions[0] = float4(11.000000,0.000000,0.000000,1.000000);//Power (Unknown) Opacity Mask Switch Opacity
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local3 = lerp(Material.VectorExpressions[4].rgb,Material.VectorExpressions[3].rgb,MaterialFloat(Local1.r));
	MaterialFloat3 Local4 = (Material.VectorExpressions[4].rgb * Local3);
	MaterialFloat3 Local5 = (Local4 * Material.VectorExpressions[6].rgb);
	MaterialFloat3 Local6 = (Local5 + Material.VectorExpressions[8].rgb);
	MaterialFloat3 Local7 = PositiveClampedPow(Local6,Material.ScalarExpressions[0].x);
	MaterialFloat3 Local8 = lerp(Local7,Material.VectorExpressions[9].rgb,MaterialFloat(Material.ScalarExpressions[0].y));
	MaterialFloat Local9 = lerp(Local1.g,Local1.b,Material.ScalarExpressions[0].z);
	MaterialFloat Local10 = (Material.ScalarExpressions[0].w * Local9);

	PixelMaterialInputs.EmissiveColor = Local8;
	PixelMaterialInputs.Opacity = Local10;
