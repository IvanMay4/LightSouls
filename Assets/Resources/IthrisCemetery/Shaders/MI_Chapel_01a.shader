Shader "Unreal/MI_Chapel_01a"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "Normal", 2D ) = "white" {}
		Material_Texture2D_1( "Detail Normal", 2D ) = "white" {}
		Material_Texture2D_2( "JT_Indented_DT_01_Normal", 2D ) = "white" {}
		Material_Texture2D_3( "JT_Indented_DT_01_ORM", 2D ) = "white" {}
		Material_Texture2D_4( "Albedo", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.078125,0.077578,0.076904,1.000000);//Detail Albedo Hue
	Material.VectorExpressions[3] = float4(0.078125,0.077578,0.076904,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(1.000000,1.000000,1.000000,1.000000);//HUE
	Material.VectorExpressions[5] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,1.000000,0.000000,23.312830);//Tiling Baked Normal INT (Unknown) Detail Normal UV
	Material.ScalarExpressions[1] = float4(1.680021,-0.680021,11.000000,-1.515477);//Detail Normal INT (Unknown) Detail Texture 02 Tiling Detail Normal 02 INT
	Material.ScalarExpressions[2] = float4(2.515477,0.000000,0.000000,1.000000);//(Unknown) (Unknown) Detail Albedo Contrast Detail Albedo Power
	Material.ScalarExpressions[3] = float4(1.000000,0.000000,1.000000,1.000000);//(Unknown) (Unknown) Detail Albedo Intensity Roughness Max
	Material.ScalarExpressions[4] = float4(0.000000,0.000000,0.000000,0.000000);//Roughness Min (Unknown) (Unknown) (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local4 = lerp(Local2.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),MaterialFloat(Material.ScalarExpressions[0].z));
	MaterialFloat Local5 = (Local4.b + 1.00000000);
	MaterialFloat2 Local6 = (Parameters.TexCoords[1].xy * Material.ScalarExpressions[0].w);
	MaterialFloat Local7 = MaterialStoreTexCoordScale(Parameters, Local6, 3);
	MaterialFloat4 Local8 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Local6,View.MaterialTextureMipBias));
	...
	MaterialFloat Local12 = dot(MaterialFloat3(Local4.rg,Local5), MaterialFloat3(Local11,Local10.b));
	MaterialFloat3 Local13 = (MaterialFloat3(Local4.rg,Local5) * Local12);
	MaterialFloat3 Local14 = (Local5 * MaterialFloat3(Local11,Local10.b));
	MaterialFloat3 Local15 = (Local13 - Local14);
	MaterialFloat Local16 = (Local15.b + 1.00000000);
	MaterialFloat2 Local17 = (Parameters.TexCoords[0].xy * Material.ScalarExpressions[1].z);
	MaterialFloat Local18 = MaterialStoreTexCoordScale(Parameters, Local17, 5);
	MaterialFloat4 Local19 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local17,View.MaterialTextureMipBias));
	MaterialFloat Local20 = MaterialStoreTexSample(Parameters, Local19, 5);
	MaterialFloat3 Local21 = lerp(Local19.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),MaterialFloat(Material.ScalarExpressions[2].x));
	MaterialFloat2 Local22 = (Local21.rg * -1.00000000);
	MaterialFloat Local23 = dot(MaterialFloat3(Local15.rg,Local16), MaterialFloat3(Local22,Local21.b));
	MaterialFloat3 Local24 = (MaterialFloat3(Local15.rg,Local16) * Local23);
	MaterialFloat3 Local25 = (Local16 * MaterialFloat3(Local22,Local21.b));
	MaterialFloat3 Local26 = (Local24 - Local25);

	// The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = Local26;
	...
	MaterialFloat3 Local27 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.VectorExpressions[1].rgb,MaterialFloat(Material.ScalarExpressions[2].y));
	MaterialFloat Local28 = MaterialStoreTexCoordScale(Parameters, Local17, 4);
	MaterialFloat4 Local29 = Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Local17,View.MaterialTextureMipBias);
	MaterialFloat Local30 = MaterialStoreTexSample(Parameters, Local29, 4);
	MaterialFloat Local31 = PositiveClampedPow(Local29.g,Material.ScalarExpressions[2].w);
	MaterialFloat Local32 = lerp(Material.ScalarExpressions[3].y,Material.ScalarExpressions[3].x,Local31);
	MaterialFloat Local33 = min(max(Local32,0.00000000),1.00000000);
	MaterialFloat Local34 = (Material.ScalarExpressions[3].z * Local33.r);
	MaterialFloat3 Local35 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.VectorExpressions[3].rgb,MaterialFloat(Local34));
	MaterialFloat Local36 = MaterialStoreTexCoordScale(Parameters, Local0, 1);
	MaterialFloat4 Local37 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4, Material_Texture2D_4Sampler,Local0,View.MaterialTextureMipBias));
	MaterialFloat Local38 = MaterialStoreTexSample(Parameters, Local37, 1);
	MaterialFloat3 Local39 = (Material.VectorExpressions[5].rgb * Local37.rgb);
	MaterialFloat3 Local40 = (Local35 + Local39);
	MaterialFloat Local41 = MaterialStoreTexCoordScale(Parameters, Local0, 0);
	MaterialFloat4 Local42 = Texture2DSampleBias(Material_Texture2D_5, Material_Texture2D_5Sampler,Local0,View.MaterialTextureMipBias);
	MaterialFloat Local43 = MaterialStoreTexSample(Parameters, Local42, 0);
	MaterialFloat Local44 = lerp(Material.ScalarExpressions[4].x,Material.ScalarExpressions[3].w,Local42.g);

	PixelMaterialInputs.EmissiveColor = Local27;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local40;
	PixelMaterialInputs.Metallic = Local42.b;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local44;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local42.r;
