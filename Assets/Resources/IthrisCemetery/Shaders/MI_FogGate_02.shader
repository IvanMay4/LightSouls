Shader "Unreal/MI_FogGate_02"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "Albedo", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(0.078000,0.000000,0.000000,1.000000);//Noise 01 Speed
	Material.VectorExpressions[2] = float4(0.078000,0.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[3] = float4(0.000000,0.000000,0.000000,1.000000);//Albedo_Color01
	...
	Material.ScalarExpressions[0] = float4(0.000000,0.078000,0.000000,-2.000000);//Albedo_Contrast (Unknown) (Unknown) Noise 01 UV
	Material.ScalarExpressions[1] = float4(1.000000,0.000000,2.000000,1.000000);//(Unknown) (Unknown) Albedo_Intensity EmissiveIntensity
	Material.ScalarExpressions[2] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown) (Unknown) (Unknown) (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local0 = (fmod(View.GameTime,10000.00000000) * Material.ScalarExpressions[0].y);
	MaterialFloat Local1 = (fmod(View.GameTime,10000.00000000) * Material.ScalarExpressions[0].z);
	MaterialFloat2 Local2 = (Parameters.TexCoords[0].xy * Material.ScalarExpressions[0].w);
	MaterialFloat2 Local3 = (MaterialFloat2(Local0,Local1) + Local2);
	MaterialFloat Local4 = MaterialStoreTexCoordScale(Parameters, Local3, 2);
	MaterialFloat4 Local5 = Texture2DSampleBias(Material_Texture2D_0, Material_Texture2D_0Sampler,Local3,View.MaterialTextureMipBias);
	MaterialFloat Local6 = MaterialStoreTexSample(Parameters, Local5, 2);
	MaterialFloat Local7 = lerp(Material.ScalarExpressions[1].y,Material.ScalarExpressions[1].x,Local5.rgb.r);
	MaterialFloat Local8 = min(max(Local7,0.00000000),1.00000000);
	MaterialFloat Local9 = (Local8.r * Material.ScalarExpressions[1].z);
	MaterialFloat3 Local10 = (Local9 * Material.VectorExpressions[4].rgb);
	MaterialFloat3 Local11 = (Local10 * Material.ScalarExpressions[1].w);
	MaterialFloat3 Local12 = lerp(Local11,Material.VectorExpressions[5].rgb,MaterialFloat(Material.ScalarExpressions[2].x));
