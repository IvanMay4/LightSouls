...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,1.000000,0.000000,5.791631);//Tiling Baked Normal INT (Unknown) Detail Normal UV
	Material.ScalarExpressions[1] = float4(0.525408,0.474592,0.000000,1.000000);//Detail Normal INT (Unknown) (Unknown) Roughness Max
	Material.ScalarExpressions[2] = float4(0.161905,0.000000,0.000000,0.000000);//Roughness Min (Unknown) (Unknown) (Unknown)
