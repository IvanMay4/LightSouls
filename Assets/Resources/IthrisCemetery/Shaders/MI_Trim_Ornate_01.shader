Shader "Unreal/MI_Trim_Ornate_01"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.229167,0.229167,0.229167,1.000000);//MisColor
	Material.VectorExpressions[5] = float4(0.229167,0.229167,0.229167,0.000000);//(Unknown)
	Material.VectorExpressions[6] = float4(0.062500,0.052207,0.039026,1.000000);//WaterDrip
	Material.VectorExpressions[7] = float4(0.062500,0.052207,0.039026,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,1.000000,0.000000,0.000000);//Tiling Normal INT (Unknown) (Unknown)
	Material.ScalarExpressions[1] = float4(0.472630,1.472630,-0.472630,0.257645);//Contrast_Blend1 (Unknown) (Unknown) Power_Blend1
	Material.ScalarExpressions[2] = float4(0.472630,1.472630,-0.472630,7.451579);//Contrast_Blend2 (Unknown) (Unknown) Power_Blend2
	Material.ScalarExpressions[3] = float4(0.315812,-0.321846,0.000000,0.000000);//MisColor Roughness Drip Roughness (Unknown) (Unknown)
