Shader "Unreal/MI_Statue_Praying_01b"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.775822,0.745404,0.708376,1.000000);//HUE
	Material.VectorExpressions[3] = float4(0.775822,0.745404,0.708376,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,1.000000,0.000000,8.000000);//Tiling Baked Normal INT (Unknown) Detail Normal UV
	Material.ScalarExpressions[1] = float4(0.000000,1.000000,0.000000,1.000000);//Detail Normal INT (Unknown) (Unknown) Roughness Max
	Material.ScalarExpressions[2] = float4(0.000000,0.000000,0.000000,0.000000);//Roughness Min (Unknown) (Unknown) (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local16 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.VectorExpressions[1].rgb,MaterialFloat(Material.ScalarExpressions[1].z));
	MaterialFloat Local17 = MaterialStoreTexCoordScale(Parameters, Local0, 1);
	MaterialFloat4 Local18 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local0,View.MaterialTextureMipBias));
	MaterialFloat Local19 = MaterialStoreTexSample(Parameters, Local18, 1);
	MaterialFloat3 Local20 = (Material.VectorExpressions[3].rgb * Local18.rgb);
	MaterialFloat Local21 = MaterialStoreTexCoordScale(Parameters, Local0, 0);
	MaterialFloat4 Local22 = Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Local0,View.MaterialTextureMipBias);
	MaterialFloat Local23 = MaterialStoreTexSample(Parameters, Local22, 0);
	MaterialFloat Local24 = lerp(Material.ScalarExpressions[2].x,Material.ScalarExpressions[1].w,Local22.g);

	PixelMaterialInputs.EmissiveColor = Local16;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local20;
	PixelMaterialInputs.Metallic = Local22.b;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local24;
