Shader "Unreal/MI_StairRailing_01"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,1.000000,0.000000,4.000000);//Tiling Baked Normal INT (Unknown) Detail Normal UV
	Material.ScalarExpressions[1] = float4(0.000000,1.000000,0.000000,1.000000);//Detail Normal INT (Unknown) (Unknown) Roughness Max
	Material.ScalarExpressions[2] = float4(-0.600000,0.000000,0.000000,0.000000);//Roughness Min (Unknown) (Unknown) (Unknown)
