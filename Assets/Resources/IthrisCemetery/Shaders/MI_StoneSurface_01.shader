Shader "Unreal/MI_StoneSurface_01"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.734375,0.734375,0.734375,1.000000);//MisColor
	Material.VectorExpressions[5] = float4(0.734375,0.734375,0.734375,0.000000);//(Unknown)
	Material.VectorExpressions[6] = float4(0.057292,0.057292,0.057292,1.000000);//WaterDrip
	Material.VectorExpressions[7] = float4(0.057292,0.057292,0.057292,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(3.000000,1.000000,0.000000,0.000000);//Tiling Normal INT (Unknown) (Unknown)
	Material.ScalarExpressions[1] = float4(0.000000,1.000000,0.000000,2.113534);//Contrast_Blend1 (Unknown) (Unknown) Power_Blend1
	Material.ScalarExpressions[2] = float4(0.000000,1.000000,0.000000,10.000000);//Contrast_Blend2 (Unknown) (Unknown) Power_Blend2
	Material.ScalarExpressions[3] = float4(-0.104762,0.000000,0.000000,0.000000);//MisColor Roughness Drip Roughness (Unknown) (Unknown)
