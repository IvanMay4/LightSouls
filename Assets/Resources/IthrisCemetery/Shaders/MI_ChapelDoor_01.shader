Shader "Unreal/MI_ChapelDoor_01"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,2.000000,-1.000000,16.811352);//Tiling Baked Normal INT (Unknown) Detail Normal UV
	Material.ScalarExpressions[1] = float4(0.408820,0.591180,0.000000,1.000000);//Detail Normal INT (Unknown) (Unknown) Roughness Max
