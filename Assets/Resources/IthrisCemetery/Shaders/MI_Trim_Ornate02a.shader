Shader "Unreal/MI_Trim_Ornate02a"
{
	Properties
	{
		...
		Material_Texture2D_2( "MASK", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(1.000000,1.000000,1.000000,1.000000);//HUE
	Material.VectorExpressions[3] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(0.546875,0.546875,0.546875,1.000000);//MisColor
	Material.VectorExpressions[5] = float4(0.546875,0.546875,0.546875,0.000000);//(Unknown)
	Material.VectorExpressions[6] = float4(0.056128,0.056128,0.056128,1.000000);//WaterDrip
	Material.VectorExpressions[7] = float4(0.056128,0.056128,0.056128,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,1.000000,0.000000,0.000000);//Tiling Normal INT (Unknown) (Unknown)
	Material.ScalarExpressions[1] = float4(0.000000,1.000000,0.000000,11.000000);//Contrast_Blend1 (Unknown) (Unknown) Power_Blend1
	Material.ScalarExpressions[2] = float4(0.000000,1.000000,0.000000,11.000000);//Contrast_Blend2 (Unknown) (Unknown) Power_Blend2
	Material.ScalarExpressions[3] = float4(-0.115661,0.000000,0.000000,0.000000);//MisColor Roughness Drip Roughness (Unknown) (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local5 = MaterialStoreTexCoordScale(Parameters, Local0, 0);
	...
	MaterialFloat3 Local8 = lerp(Local6.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),MaterialFloat(Material.ScalarExpressions[0].z));
	...
	MaterialFloat3 Local9 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.VectorExpressions[1].rgb,MaterialFloat(Material.ScalarExpressions[0].w));
	MaterialFloat Local10 = MaterialStoreTexCoordScale(Parameters, Local0, 5);
	MaterialFloat4 Local11 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Local0,View.MaterialTextureMipBias));
	MaterialFloat Local12 = MaterialStoreTexSample(Parameters, Local11, 5);
	MaterialFloat3 Local13 = (Material.VectorExpressions[3].rgb * Local11.rgb);
	MaterialFloat3 Local14 = (Material.VectorExpressions[5].rgb * Local13);
	MaterialFloat Local15 = (1.00000000 - Parameters.VertexColor.r);
	MaterialFloat Local16 = MaterialStoreTexCoordScale(Parameters, Local0, 1);
	MaterialFloat4 Local17 = Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local0,View.MaterialTextureMipBias);
	MaterialFloat Local18 = MaterialStoreTexSample(Parameters, Local17, 1);
	MaterialFloat Local19 = (1.00000000 - Local17.r);
	MaterialFloat Local20 = (Local15 * Local19);
	MaterialFloat Local21 = lerp(Material.ScalarExpressions[1].z,Material.ScalarExpressions[1].y,Local20);
	MaterialFloat Local22 = min(max(Local21,0.00000000),1.00000000);
	MaterialFloat Local23 = PositiveClampedPow(Local22.r,Material.ScalarExpressions[1].w);
	MaterialFloat Local24 = min(max(Local23,0.00000000),1.00000000);
	MaterialFloat3 Local25 = lerp(Local13,Local14,MaterialFloat(Local24));
	MaterialFloat3 Local26 = (Material.VectorExpressions[7].rgb + Local25);
	MaterialFloat Local27 = (1.00000000 - Parameters.VertexColor.g);
	MaterialFloat Local28 = (Local27 * Local17.g);
	MaterialFloat Local29 = lerp(Material.ScalarExpressions[2].z,Material.ScalarExpressions[2].y,Local28);
	MaterialFloat Local30 = min(max(Local29,0.00000000),1.00000000);
	MaterialFloat Local31 = PositiveClampedPow(Local30.r,Material.ScalarExpressions[2].w);
	MaterialFloat Local32 = min(max(Local31,0.00000000),1.00000000);
	MaterialFloat3 Local33 = lerp(Local25,Local26,MaterialFloat(Local32));
	MaterialFloat4 Local34 = Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Local0,View.MaterialTextureMipBias);
	MaterialFloat Local35 = MaterialStoreTexSample(Parameters, Local34, 1);
	MaterialFloat Local36 = (0.00000000 * Local34.b);
	MaterialFloat Local37 = lerp(Local34.b,Local36,Local24);
	MaterialFloat Local38 = lerp(Local37,0.00000000,Local32);
	MaterialFloat Local39 = (Material.ScalarExpressions[3].x + Local34.g);
	MaterialFloat Local40 = lerp(Local34.g,Local39,Local24);
	MaterialFloat Local41 = (Material.ScalarExpressions[3].y + Local40);
	MaterialFloat Local42 = lerp(Local40,Local41,Local32);
	...
	PixelMaterialInputs.AmbientOcclusion = Local34.r;
