Shader "Unreal/MI_Trim_Ornate02b"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(1.000000,1.000000,1.000000,1.000000);//MisColor
	Material.VectorExpressions[5] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[6] = float4(0.000000,0.000000,0.000000,1.000000);//WaterDrip
	...
	Material.ScalarExpressions[1] = float4(0.000000,1.000000,0.000000,10.000000);//Contrast_Blend1 (Unknown) (Unknown) Power_Blend1
	Material.ScalarExpressions[2] = float4(0.000000,1.000000,0.000000,10.000000);//Contrast_Blend2 (Unknown) (Unknown) Power_Blend2
	Material.ScalarExpressions[3] = float4(1.000000,0.000000,0.000000,0.000000);//MisColor Roughness Drip Roughness (Unknown) (Unknown)
